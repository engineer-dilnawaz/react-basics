...
const Accordion = ({ reviews, expandedItem, onItemClick }) => {
  ...
  return (
    <div
      ...
      className="flex flex-col p-2 w-full mt-3 bg-gray-50 rounded-md cursor-pointer hover:bg-gray-50 transition-colors duration-200 select-none"
    >
...
const AccordionItem = ({ review, isExpanded, idx }) => {
  return (
    <div
